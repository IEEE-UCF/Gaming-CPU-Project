...
* Insert interface triggered by sv32\_mmu after PTW completion.
...
PTW: Page Table Walker. External MMU logic that fetches page-table entries on TLB misses.

MMU: Memory Management Unit. Performs address translation and permission checks.

PTE: 32-bit page table entry. Descriptor defining a mapping between virtual and physical pages.
